...
<head>
    ...
    <title>Strike Gear</title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/css/bootstrap.min.css" integrity="sha384-sRIl4kxILFvY47J16cr9ZwB07vP4J8+LH7qKQnuqkuIAvNWLzeN8tE5YBujZqJLB" crossorigin="anonymous">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Jockey+One&family=Playfair+Display:ital,wght@0,400..900;1,400..900&display=swap">
...
<body>
    ...
    <section class="hero-single">
        <div class="hero-background">
            <img src="assets/orangmancing.png" alt="Orang Memancing">
        </div>
        <div class="hero-gradient"></div>
        <div class="hero-text-overlay">
            <h3>Marketplace Alat Pancing</h3>
            <h1>Strike Gear</h1>
            <p class="hero-sub">Temukan perlengkapan pancing terbaik untuk setiap petualangan. Dari joran hingga umpan, semua ada di sini.</p>
            <a href="kategori.php" class="btn-shop">SHOP NOW</a>
        </div>
    </section>

    <section class="section-tiga py-5" id="section-tiga">
        <div class="container text-center">
            <h2>Find your needs!</h2>
            <div class="slider-container">
                <div class="slider">
                    <div class="slide"><a href="kategori.php"><img src="assets/reel.png" alt="Reel"></a></div>
                    <div class="slide"><a href="kategori.php"><img src="assets/benang.png" alt="Benang"></a></div>
                    <div class="slide"><a href="kategori.php"><img src="assets/umpan.png" alt="Umpan"></a></div>
                    <div class="slide"><a href="kategori.php"><img src="assets/joran.jpg" alt="Joran"></a></div>
                    <div class="slide"><a href="kategori.php"><img src="assets/kail.png" alt="Kail"></a></div>
                </div>
    ...
    <section class="community-section">
        <h2 class="community-title">Ask Our Community</h2>

        <div class="community-row">
            <a href="https://discord.gg/DRYXJXCwT" target="_blank" class="community-link">
                <div class="community-circle">
                    <i class="bi bi-discord"></i>
                </div>
                <div class="community-text">
                    <p class="community-name">Strike Gear</p>
                    <p class="community-sub">Discord Community</p>
                </div>
            </a>

            <a href="https://wa.me/6285233679797?text=Halo%20Strike%20Gear,%20saya%20mau%20tanya!" target="_blank" class="community-link">
                <div class="community-circle">
                    <i class="bi bi-whatsapp"></i>
                </div>
                <div class="community-text">
                    <p class="community-name">Strike Gear</p>
                    <p class="community-sub">Admin Contact</p>
                </div>
            </a>
        </div>

        <h2 class="community-title">Ask Our AI Chatbox!</h2>

        <div class="community-row">
            <a href="#" onclick="document.getElementById('aiChatbox').classList.toggle('active'); return false;" class="community-link">
                <div class="community-circle">
                    <i class="bi bi-robot"></i>
                </div>
                <div class="community-text">
                    <p class="community-name">Strike Gear</p>
                    <p class="community-sub">AI Chatbox</p>
                </div>
            </a>
        </div>
    </section>
